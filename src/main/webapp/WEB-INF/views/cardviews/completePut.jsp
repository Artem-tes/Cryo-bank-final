    ...
    <div class="container">
        <div class="section">
            ...
            <div class="transaction-details">
                ...
                <p><strong>Сумма перевода:</strong> <%= request.getAttribute("amount") %> RUB</p>
                <p><strong>Текущий баланс:</strong> <%=card.getBalance() %> RUB</p>
                <p><strong>На карту:</strong> <%= request.getAttribute("recipientCard") %></p>
                <p><strong>Дата и время:</strong> <%= request.getAttribute("transactionDate") %></p>
            </div>
