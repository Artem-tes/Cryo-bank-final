...
<head>
    ...
    <title>Карта успешно создана</title>
    <style>
        body {
...
<body>
    <header>
        ...
        Успешное создание Cryo Карты
    </header>

    <div class="container">
        <div class="section">
            <div class="success-icon">🎉</div>
            <h2>Ваша Cryo Карта успешно создана!</h2>
            ...
            <div class="card-details">
                ...
                %>
                    ...
                    <p><strong>Номер карты:</strong> <%= card.getNumber() %></p>
                    <p><strong>Дата - </strong> <%= card.getDate() %></p>
                    <p><strong>Тип - </strong> Банковская</p>
                    <p><strong>Валюта - </strong> Рубли</p>
                <% } else { %>
                    <p>Информация о карте недоступна.</p>
                <% } %>
            </div>
