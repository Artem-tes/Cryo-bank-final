...
<body>
    ...
    <div class="container">
        <div class="section">
            <h2>Положите деньги быстро и безопасно</h2>
            <form id="sendMoneyForm" action="/account/put-money" method="post">
                <div class="form-group">
                    <label for="senderCard">Номер вашей карты</label>
                    <input type="text" id="senderCard" name="senderCard" placeholder="0000 0000" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    Введите пароль к логину которого привязана карта" required>
                </div>
