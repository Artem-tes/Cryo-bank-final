    ...
    <div class="container">
        <div class="section">
            ...
            <div class="error-message">
                <p>К сожалению, для регистрации компании вам необходимо иметь активную карту Cryo банка. Без карты мы не можем привязать вашу компанию к вашему аккаунту.</p>
