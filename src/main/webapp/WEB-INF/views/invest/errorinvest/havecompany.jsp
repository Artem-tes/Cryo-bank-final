...
<body>
    ...
    <div class="container">
        <div class="section">
            ...
            <h2>У вас уже есть компания</h2>

            <!-- Сообщение об ошибке -->
            <div class="error-message">
                <p>К сожалению, в нашем банке вы можете зарегистрировать только одну компанию. У вас уже есть активная компания, поэтому создание новой невозможно.</p>
                <p>Если вы хотите изменить данные вашей компании или закрыть ее, пожалуйста, обратитесь в поддержку.</p>

                <h3>Что вы можете сделать:</h3>
                <ul>
                    <li><strong>Управляйте текущей компанией:</strong> Перейдите в личный кабинет, чтобы управлять вашей компанией.</li>
