...
<body>
    ...
    <div class="container">
        <div class="section">
            ...
            <h2>Неправильный пароль</h2>

            <!-- Сообщение об ошибке -->
            <div class="error-message">
                <p>К сожалению, введенный вами пароль неверен. Мы не можем подтвердить вашу личность для создания компании.</p>
            ...
            <div class="button-group">
                <button onclick="location.href='/account/create-company'">Попробовать снова</button>
