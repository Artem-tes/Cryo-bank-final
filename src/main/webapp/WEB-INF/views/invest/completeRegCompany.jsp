...
<head>
    ...
    <title>Компания успешно создана</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="section">
            ...
            <h2>Ваша компания успешно создана!</h2>

            <!-- Детали компании -->
            <div class="company-details">
                <h3>Детали компании</h3>
                <p><strong>Название компании:</strong> ${name}</p>
                <p><strong>Описание компании:</strong> ${desc}</p>
                <p><strong>Начальный капитал:</strong> ${capital} RUB</p>
                <p><strong>Дата:</strong> ${date} RUB</p>
            </div>
