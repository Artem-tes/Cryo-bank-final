    ...
    <div class="container">
        <div class="section">
            ...
            <div class="error-message">
                <p>К сожалению, на вашей карте недостаточно средств для выполнения перевода.</p>
                <p>Текущий баланс вашей карты: <strong>${balance} RUB</strong>.
                Для выполнения перевода требуется: <strong>${amount} RUB</strong>.</p>

                <h3>Что вы можете сделать:</h3>
                <ul>
                    <li><strong>Пополните баланс:</strong> Вы можете пополнить баланс вашей карты через наш сайт или мобильное приложение.</li>
                    <li><strong>Уменьшите сумму перевода:</strong> Попробуйте выполнить перевод на меньшую сумму, которая не превышает ваш текущий баланс.</li>
                ...
                <p>Вы можете пополнить баланс, перейдя по <a href="/account/put-money">этой ссылке</a>. Мы поддерживаем различные способы пополнения, включая банковские карты и электронные кошельки.</p>
